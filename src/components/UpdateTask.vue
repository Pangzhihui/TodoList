<template>
    <div class="add">
        <div class="hd-add">
            ...
            <button class="btn btn-default btn-add" id="all-d" @click="update()">Done</button>
        </div>
        <div class="pri">
...
<script>
    export default {
        ...
        mounted : function() {
            ...
            var task = this.$store.state.list[this.id];
            if(task.pri == 'red') {
                this.pri1 = true;
            }
            else if(task.pri == 'yellow') {
                this.pri2 = true;
            }
            else {
                this.pri3 = true;
            }
            if(task.sta == 'glyphicon-play') {
                this.sta1 = true;
            }
            else if(task.sta == 'glyphicon-pause') {
                this.sta2 = true;
            }
            else {
                this.sta3 = true;
